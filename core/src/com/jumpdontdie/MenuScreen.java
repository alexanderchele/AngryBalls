...
public class MenuScreen extends BaseScreen {
    ...
    private TextButton play, selectPlayer;
    ...
    public MenuScreen(final MainGame Game) {
        ...
        selectPlayer = new TextButton("Elejir Jugador", skin);
        ...
        selectPlayer.addCaptureListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
               // Game.setScreen(Game.creditsScreen);
                Game.setScreen(Game.playerScreen);
            }
        });
        ...
        play.setSize(200, 80);
        selectPlayer.setSize(200, 80);
        play.setPosition(40, 140);
        selectPlayer.setPosition(40, 40);
